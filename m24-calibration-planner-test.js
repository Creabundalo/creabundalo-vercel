...
globalThis.__m24CalibrationSnapshots=[
 ...
 'm24-verified-generated-eth-2023-02-16.json','m24-verified-generated-eth-2020-07-22.json'
...
(()=>{
 ...
 check(mechanics?.currentCases===1&&mechanics.episodeDeficit===29,'canonical mechanics-core deficit');
 ...
 globalThis.__m24fs.writeFileSync('m24-calibration-plan-snapshot.json',JSON.stringify({...plan,expansionQueue:queue},null,2));
