globalThis.M24Macro = (() => {
  ...
  const SERIES=Object.freeze({
    VIX:Object.freeze({id:'VIXCLS',label:'CBOE Volatility Index',family:'VOLATILITY',units:'index',frequency:'daily',source:'Cboe via FRED',higherMeaning:'HIGHER_MARKET_STRESS'}),
